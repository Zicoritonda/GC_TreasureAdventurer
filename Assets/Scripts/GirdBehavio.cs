...
public class GirdBehavio : MonoBehaviour
{
    public int rows = 10;
    ...
    private void Awake()
    {
        ...
        else Debug.Log("Missing gridprefab");
    }
    ...
    void SetPath()
    {
        ...
        path.Clear();
        if (gridArray[endX, endX] && gridArray[endX, endY].GetComponent<GridStat>().visited > 0)
        {
        ...
        {
            Debug.Log("Cant reach deestination");
            return;
        }
